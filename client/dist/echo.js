	...
	function (msg, model) {
		switch (msg.$) {
			...
			case 'Submit':
				...
				return _Utils_Tuple2(
					model,
					author$project$Main$websocketOut(value));
			default:
				var value = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							responses: A2(elm$core$List$cons, value, model.responses)
						}),
					elm$core$Platform$Cmd$none);
		}
	});
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								elm$html$Html$text('BattleField')
							]))
					])),
				A2(
				elm$html$Html$div,
					...
					[
						...
						_List_fromArray(
							[
								...
								author$project$Main$Submit('asd'))
							]),
						_List_fromArray(
							[
								elm$html$Html$text('BattleField')
